...
class BotHandler:
    ...
    # TODO:игра может повиснуть из-за отсутствия действий игроков не только на
    # стадии ставок, но и на стадии, когда игроки решают, брать ли карту;
    # - если все они уже отказались брать карту или у них перебор, далее от их
    # действий игра не зависит и может сама завершиться;
    # - можно выкидывать из игры игроков, которые бездействуют (т.е. удалять их
    # геймплеи), и если в итоге у игры не осталось геймплеев, то завершать ее
    # (писать, что диллер победил, т.к. все игроки были кинуты за бездействие)
