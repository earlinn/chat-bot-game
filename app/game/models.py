...
# TIMER_DELAY_IN_SECONDS, а иметь возможность редактировать через Админку,
# а константа станет временем по дефолту. Можно сделать одно поле для таймера
# на стадии присоединения игроков и второе поле для таймера на стадии ставок.
